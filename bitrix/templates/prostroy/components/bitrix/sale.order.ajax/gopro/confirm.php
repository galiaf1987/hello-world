...
{
	$arItems = array();
	$rs = CSaleBasket::GetList(array(), array("ORDER_ID"=>$arResult["ORDER_ID"]));
	while($ar = $rs->GetNext()) {
		$arItems[] = '{"id": "'.$ar['PRODUCT_ID'].'", "name": "'.$ar['NAME'].'", "price": '.$ar['PRICE'].', "quantity": '.$ar['QUANTITY'].'}';
	}
