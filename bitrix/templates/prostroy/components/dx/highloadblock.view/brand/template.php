...
<?
	$APPLICATION->AddChainItem($arResult['fields']['UF_NAME']['VALUE']);
	$APPLICATION->SetTitle($arResult['fields']['UF_NAME']['VALUE']);
?>
<?if($arResult['fields']['UF_FILE']['VALUE']):?>
	<?
		$arFile = CFile::GetFileArray($arResult['fields']['UF_FILE']['VALUE']);
	?>
	<?if($arResult['fields']['UF_LINK']['VALUE']):?>
		<a href="<?=$arResult['fields']['UF_LINK']['VALUE']?>">
	<?endif;?>
	<img src="<?=$arFile["SRC"]?>" style="margin:5px 10px; float:left;" />
	<?if($arResult['fields']['UF_LINK']['VALUE']):?>
		</a>
	<?endif;?>
<?endif;?>
<?=$arResult['fields']['UF_FULL_DESCRIPTION']['VALUE']?>
<?if($arResult['fields']['UF_LINK']['VALUE']):?>
<br />
<p align="right">
	<a href="<?=$arResult['fields']['UF_LINK']['VALUE']?>"><?=$arResult['fields']['UF_LINK']['VALUE']?></a>
</p>
<?endif;?>
