...
//if ($arResult['IPROPERTY_VALUES']['ELEMENT_META_TITLE'] === $arResult['IPROPERTY_VALUES']['ELEMENT_PAGE_TITLE']) {
  //$APPLICATION->SetPageProperty('title', $arResult['NAME'] . ' - купить, цена в Москве | Otoplenie Store');
//}
if (!isset($arResult['IPROPERTY_VALUES']['ELEMENT_META_KEYWORDS'])) {
  $APPLICATION->SetPageProperty('keywords', $arResult['NAME'] . ', интернет магазин Otoplenie Store');
}
if (!isset($arResult['IPROPERTY_VALUES']['ELEMENT_META_DESCRIPTION'])) {
