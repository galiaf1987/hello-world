...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/_all/catalog-'.LANGUAGE_ID.'.xml';
$iblockXMLFilePrices = WIZARD_SERVICE_RELATIVE_PATH.'/xml/_all/catalog_prices-'.LANGUAGE_ID.'.xml';
$iblockCode = 'catalog';
...
if($iblockID == false){
	...
	if($arFields = $res->GetNext())
	{
		...
		$arNewFields['USER_TYPE_SETTINGS']['TABLE_NAME'] = 'prostroy_brand_reference';
