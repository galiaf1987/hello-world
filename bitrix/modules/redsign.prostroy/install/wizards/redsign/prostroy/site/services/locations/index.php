...
$locationsClear = $wizard->GetVar('locations_clear');
if($locationsClear == 'Y' )
{
...
COption::SetOptionString('sale', 'location_zip', '123456');
COption::SetOptionString('sale', 'location', $locatCode);