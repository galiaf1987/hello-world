...
CModule::IncludeModule('redsign.prostroy');
...
if( (isset($_REQUEST['save']) ||isset($_REQUEST['apply']) ) && check_bitrix_sessid()){
	COption::SetOptionString('redsign.prostroy', 'adaptive', $_REQUEST['adaptive']=='Y' ? 'Y' : 'N' );
	COption::SetOptionInt('redsign.prostroy', 'clickprotectiondelay', IntVal($_REQUEST['clickprotectiondelay']) );
	COption::SetOptionInt('redsign.prostroy', 'requestdelay', IntVal($_REQUEST['requestdelay']) );
	COption::SetOptionString('redsign.prostroy', 'prop_option', htmlspecialchars($_REQUEST['prop_option']) );
}
...
?></tr><?
$adaptive = COption::GetOptionString('redsign.prostroy', 'adaptive', 'Y');
?><tr><?
...
?></tr><?
$prop_option = COption::GetOptionString('redsign.prostroy', 'prop_option', 'line_through');
?><tr><?
