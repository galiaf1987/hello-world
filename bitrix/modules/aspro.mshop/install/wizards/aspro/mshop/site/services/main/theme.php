...
// theme
COption::SetOptionString("aspro.mshop", "THEME_SWITCHER", "N", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.mshop", "COLOR_THEME", strToUpper(WIZARD_THEME_ID), "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.mshop", "CUSTOM_COLOR_THEME", "01aae3", "", WIZARD_SITE_ID);
