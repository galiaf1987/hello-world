...
if(COption::GetOptionString("aspro.mshop", "wizard_installed", "N") == 'N'){
	...
	//fclose($file);
	COption::SetOptionString("aspro.mshop", "wizard_installed", "Y");
}
...
// copyright
___writeToAreasFile(WIZARD_SITE_PATH."include/copyright.php", "<?=date(\"Y\")?> &copy; ".$wizard->GetVar("siteCopy"));
// phone
$sitePhone = $wizard->GetVar("siteTelephone");
$sitePhone2 = str_replace(" ", "", $sitePhone);
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."include/phone.php", Array("SITE_PHONE" => $sitePhone));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."include/phone.php", Array("SITE_PHONE2" => $sitePhone2));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."include/basket_print_desc.php", Array("SITE_PHONE" => $sitePhone));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."include/jobs_description_phone.php", Array("SITE_PHONE" => $sitePhone));
// email
