...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_90").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_54").'--,--PROPERTY_'.$arProperty["NAME"].'--#--'.GetMessage("WZD_OPTION_92").'--,--PROPERTY_'.$arProperty["PHONE"].'--#--'.GetMessage("WZD_OPTION_94").'--,--PROPERTY_'.$arProperty["EMAIL"].'--#--'.GetMessage("WZD_OPTION_96").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_98").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_100").'--;--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'ACTIVE,NAME,PROPERTY_'.$arProperty["EMAIL"].',PROPERTY_'.$arProperty["NAME"].',PROPERTY_'.$arProperty["PHONE"].',SORT,TIMESTAMP_X,ID', 'by' => 'sort', 'order' => 'asc', 'page_size' => '20',
	));
}
