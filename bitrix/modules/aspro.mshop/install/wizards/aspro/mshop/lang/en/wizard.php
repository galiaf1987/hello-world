...
$MESS["WIZ_TEMPLATE_DESCRIPTION"] = "Цветовые параметры и расположение блоков в шаблоне настраиваются в параметрах модуля Аспро:Маркет.";
...
$MESS["WIZ_COMPANY_NAME_DEF"] = "Аспро: Маркет, интернет-магазин";
$MESS["WIZ_COMPANY_COPY"] = "Подпись сайта:";
$MESS["WIZ_COMPANY_COPY_DEF"] = "Маркет";
...
$MESS["WIZ_SHOP_PRICE_BASE_TEXT1"] = "В решении \"Аспро: Маркет - Адаптивный интернет-магазин\" используется в качестве публичных цен для просмотра и покупки базовая цена (BASE). В текущий момент для группы \"Все пользователи (в том числе неавторизованные)\" включено право на данный тип цены. Таким образом данная группа будет видеть цены в решении.";
...
$MESS["wiz_site_desc"] = "Универсальный интернет-магазин";
...
$MESS["WIZ_NO_MODULE_"] = "Не установлен модуль &laquo;Аспро: Маркет - Адаптивный интернет-магазин&raquo;. Для продолжения работы мастера <a href='/bitrix/admin/partner_modules.php'>перейдите по ссылке</a> и установите модуль.";
...
$MESS["SEARCH_REINDEX_NOTEFY"] = "Необходимо произвести полную <a href=\"/bitrix/admin/search_reindex.php?lang=".LANGUAGE_ID."\">переиндексацию сайта</a> для корректной работы поиска.";
?>