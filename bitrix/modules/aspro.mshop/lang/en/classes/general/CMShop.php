...
$MESS["MSHOP_MODULE_NOT_INSTALLED"] = 'Модуль &laquo;Аспро: Маркет - Адаптивный интернет-магазин&raquo; не установлен. Пожалуйста, <a href="/bitrix/admin/partner_modules.php">установите модуль</a> и повторите попытку.';
...
$MESS["VIEWED_TYPE_LOCAL"] = "быстрый";
$MESS["VIEWED_TYPE_BX"] = "стандартный";
...
$MESS['APPLY_PERSON_TYPE'] = 'Для отображения привязанных к типу плательщика свойств заказа необходимо выбрать нужное значение в опции "Тип плательщика" и применить настройки, после чего будут доступны необходимые свойства заказа';
$MESS['SHOW_CALLBACK'] = 'Отображать обратный звонок в шапке сайта';
?>