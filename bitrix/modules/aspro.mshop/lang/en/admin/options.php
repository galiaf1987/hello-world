...
$MESS['NO_COMPOSITE_NOTE'] = 'Включение отображения переключателя тем в публичной части сайта отменит композитное кеширование.';
$MESS['VIEWED_TYPE_LOCAL_NOTE'] = 'Внимание! В режиме быстрого показа ранее просмотренных товаров изображение, стоимость и другие данные хранятся локально. Также в целях ускорения загрузки не отображаются стикеры акций и информация о наличии.';
...
<input type="button" value="Установить" style="margin-top: 10px;" onclick="document.location.href=\'/bitrix/admin/wizard_install.php?lang=ru&wizardName=aspro:mshop&#SESSION_ID#\'">';
$MESS["WILL_CLEAR_HTML_CACHE_NOTE"] = "Будет выполнена очистка композитного (html) кеша";
