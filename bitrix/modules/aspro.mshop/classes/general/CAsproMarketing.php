...
class CAsproMarketing{
    const MODULE_ID = \CMShop::moduleID;
    const LOCAL_DIR_TMPL = "/modules/aspro.mshop/preset/template/";
    // const LOCAL_DIR_IMG = '/images/'.CMShop::moduleID.'/preset/template/';
    ...
    public static function replaceTemplateByDefaultData($template){
        ...
        $tizer_iblock_id = ($arIblocks["aspro_mshop_content"]["aspro_mshop_tizers"][0] ? $arIblocks["aspro_mshop_content"]["aspro_mshop_tizers"][0] : 0);
        $sale_iblock_id = ($arIblocks["aspro_mshop_content"]["aspro_mshop_stock"][0] ? $arIblocks["aspro_mshop_content"]["aspro_mshop_stock"][0] : 0);
        ...
        $bg_image = $siteAddressFull.'/bitrix/templates/'.str_replace(".", "_", static::MODULE_ID).'/images/icons_wish.png';
