<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			...
			a.link_img_logo{display: inline-block;zoom: 1;vertical-align: middle;margin: 0;max-height: 36px;}
			.phone_block{position:relative;text-align:right !important;padding-top:0px !important;}
			.phone_block .phone{display: inline-block;width: 9px;height:20px;vertical-align: top;}
			.colored .phone_block .phone{background-position: -3px -199px !important;}
			.phone_block a{text-decoration:none;}
			.colored .phone_block, .colored .phone_block a{color:#fff;}
			.main .phone_block, .main .phone_block a{color:#1d2029;}
																			...
																			<tr>
																				<td valign="top" class="bxBlockPadding bxBlockContentText">
																					<div class="phone_block">
																						<div class="phone" style="background:url(%IMAGE_URL%) -29px -176px no-repeat;margin-right: 5px;"></div>
																						%PHONE%
																					</div>
																				</td>
																			</tr>
