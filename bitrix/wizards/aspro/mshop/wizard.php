...
<?include_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/wizards/aspro/mshop/css/styles.css");?>
<script>
	<?require_once($_SERVER['DOCUMENT_ROOT']."/bitrix/wizards/aspro/mshop/js/jquery-1.8.3.min.js");?>
	<?require_once($_SERVER['DOCUMENT_ROOT']."/bitrix/wizards/aspro/mshop/js/jquery.keyboard.js");?>
	function setWizardBackgroundColor(theme){
		...
		switch (theme) {
			...
			case "AZURE_KRAYOLA":
			case "azure_krayola":
				$(".instal-bg").css("backgroundColor", "#009ab2");
				break;
			case "GREEN_SEA":
			case "green_sea":
...
class SelectTemplateStep extends CSelectTemplateWizardStep{
	function InitStep(){
		...
		$wizard->SetDefaultVars(Array("templateID" => "mshop"));
	}
...
class SelectThemeStep extends CSelectThemeWizardStep{
	...
	function ShowStep(){
		...
		$ThemeID = strtolower(COption::GetOptionString("aspro.mshop", "COLOR_THEME", 'BLUE', $siteID));
	...
	function InitStep(){
		if(CModule::IncludeModule("aspro.mshop")){
			...
			if(!file_exists($siteLogo = WIZARD_SITE_PATH."include/logo.png")){
				$siteLogo = "/bitrix/wizards/aspro/mshop/site/templates/mshop/themes/".$themeID."/images/logo.png";
			}
			*/
			...
			$shopVk = $shopOdnoklassniki = $shopFacebook = $shopTwitter = $shopMailru = $shopInstagram = false;
			...
			$wizard->SetDefaultVars(
				Array(
					...
					"siteTelephone" => strip_tags($this->GetFileContent(WIZARD_SITE_PATH."include/phone.php", GetMessage("WIZ_COMPANY_TELEPHONE_DEF"))),
...
class ShopSettings extends CWizardStep{
	function InitStep(){
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("mshop", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("mshop", "shopEmail", $wizard->GetVar("siteEmail"), $siteID),
				"shopOfName" => COption::GetOptionString("mshop", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("mshop", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				//"shopZip" => 101000,
				"shopAdr" => COption::GetOptionString("mshop", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				"shopINN" => COption::GetOptionString("mshop", "shopINN", "1234567890", $siteID),
				"shopKPP" => COption::GetOptionString("mshop", "shopKPP", "123456789", $siteID),
				"shopNS" => COption::GetOptionString("mshop", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				"shopBANK" => COption::GetOptionString("mshop", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				"shopBANKREKV" => COption::GetOptionString("mshop", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				"shopKS" => COption::GetOptionString("mshop", "shopKS", "30101 810 4 0000 0000225", $siteID),
				"siteStamp" => COption::GetOptionString("mshop", "siteStamp", $siteStamp, $siteID),

				//"shopCompany_ua" => COption::GetOptionString("mshop", "shopCompany_ua", "", $siteID),
				"shopOfName_ua" => COption::GetOptionString("mshop", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				"shopLocation_ua" => COption::GetOptionString("mshop", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				"shopAdr_ua" => COption::GetOptionString("mshop", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				"shopEGRPU_ua" =>  COption::GetOptionString("mshop", "shopCompany_ua", "", $siteID),
				"shopINN_ua" =>  COption::GetOptionString("mshop", "shopINN_ua", "", $siteID),
				"shopNDS_ua" =>  COption::GetOptionString("mshop", "shopNDS_ua", "", $siteID),
				"shopNS_ua" =>  COption::GetOptionString("mshop", "shopNS_ua", "", $siteID),
				"shopBank_ua" =>  COption::GetOptionString("mshop", "shopBank_ua", "", $siteID),
				"shopMFO_ua" =>  COption::GetOptionString("mshop", "shopMFO_ua", "", $siteID),
				"shopPlace_ua" =>  COption::GetOptionString("mshop", "shopPlace_ua", "", $siteID),
				"shopFIO_ua" =>  COption::GetOptionString("mshop", "shopFIO_ua", "", $siteID),
				"shopTax_ua" =>  COption::GetOptionString("mshop", "shopTax_ua", "", $siteID),

				"installPriceBASE" => COption::GetOptionString("mshop", "installPriceBASE", "Y", $siteID),
			)
		);
	}
...
class DataInstallStep extends CDataInstallWizardStep{
	...
	function CorrectServices(&$arServices){
		if($_SESSION["BX_mshop_LOCATION"] == "Y") $this->repeatCurrentService = true;
...
class FinishStep extends CFinishWizardStep{
	...
	function ShowStep(){
		...
		COption::SetOptionString("aspro.mshop", "WIZARD_DEMO_INSTALLED", "Y");

		if(COption::GetOptionString("aspro.mshop", "WIZARD_SEARCH_REINDEXED", "N") !== 'Y'){
			$ar = Array(
			   "MESSAGE" => GetMessage("SEARCH_REINDEX_NOTEFY"),
			   "TAG" => "ASPRO_NEED_REINDEX",
			   "MODULE_ID" => "aspro.mshop",
			   "ENABLE_CLOSE" => "Y"
			);
			CAdminNotify::Add($ar);
		}
