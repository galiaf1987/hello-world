...
COption::SetOptionString("aspro.mshop", "EXPRESSION_ORDER_BUTTON", ($isUTF8 ? iconv('CP1251', 'UTF-8', 'Под заказ') : 'Под заказ'), "", WIZARD_SITE_ID);
...
COption::SetOptionString("aspro.mshop", "EXPRESSION_FOR_EXISTS", ($isUTF8 ? iconv('CP1251', 'UTF-8', 'Есть в наличии') : 'Есть в наличии'), "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.mshop", "EXPRESSION_FOR_NOTEXISTS", ($isUTF8 ? iconv('CP1251', 'UTF-8', 'Нет в наличии') : 'Нет в наличии'), "", WIZARD_SITE_ID);
...
COption::SetOptionString("aspro.mshop", "EXPRESSION_FOR_MIN", ($isUTF8 ? iconv('CP1251', 'UTF-8', 'Мало') : 'Мало'), "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.mshop", "EXPRESSION_FOR_MID", ($isUTF8 ? iconv('CP1251', 'UTF-8', 'Достаточно') : 'Достаточно'), "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.mshop", "EXPRESSION_FOR_MAX", ($isUTF8 ? iconv('CP1251', 'UTF-8', 'Много') : 'Много'), "", WIZARD_SITE_ID);
