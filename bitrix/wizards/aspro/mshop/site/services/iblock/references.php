...
$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproMshopColorReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproMshopColorReference', 'TABLE_NAME' => 'mshop_color_reference');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["MSHOP_HBLOCK_COLOR_ID"] = $HL_ID;
